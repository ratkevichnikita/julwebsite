        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.offer}>
            ...
            <div className={styles.offerTitle}>
              ...
              <Link to={"https://payform.ru/j12S3bu/"} className={styles.button}>Купить календарь за 790 ₽</Link>
            </div>
          </div>
      ...
      <section className={`${styles.section} ${styles.bg} ${styles.who}`}>
        <div className={styles.wrapper}>
          <div>
            ...
            {/*<button onClick={() => handleClick()} className={styles.button}>Купить календарь за 790 ₽</button>*/}
            <Link to={"https://payform.ru/j12S3bu/"} className={`${styles.button} ${styles.center}`}>Купить календарь за 790 ₽</Link>
          </div>
        </div>
      </section>
      <section className={styles.section}>
