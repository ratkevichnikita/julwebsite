...
const CalendarPayment = () => {
  ...
  const products = [{
    name: 'Гайд: календарь развития ребенка',
    link: 'https://drive.google.com/drive/folders/1IDYKfLTl-VnSEgxlWT5ai4xahMlWUDvP?usp=sharing',
    price: 790
  }]
  ...
  const onHandleClick = () => {
    if(!validationFiled.error && emailField !== '') {
      ...
      createPayment(790, paymentActions, products, email)
