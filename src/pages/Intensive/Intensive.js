    ...
    <section className={styles.section}>
      ...
      <div className="wrapper">
        ...
        <div className={styles.point}>
          ...
          <a className={styles.button} href={"/"}>Хочу стать блогером</a>
        </div>
        ...
        <div className={styles.plans}>
          ...
          <ul>
            <li className={styles.plansItem}>
              {/* <img className={styles.bg4} src={bg4} alt="фон" /> */}
              <p className={styles.plansName}>«Старт»</p>
              <p className={styles.plansPrice}>990 руб.</p>
              <a href={"/"} className={styles.plansButton}>ХОЧУ «СТАРТ»</a>
            ...
            <li className={`${styles.plansItem} ${styles.plansItemExtra}`}>
              ...
              <p className={styles.plansPrice}>3.000 руб.</p>
              <a href={"/"} className={`${styles.plansButton} ${styles.plansButtonExtra}`}>ХОЧУ «ОПТИМАЛЬНЫЙ»</a>
              <div className={styles.plansContent}>
            ...
            <li className={styles.plansItem}>
              {/* <img className={styles.bg6} src={bg6} alt="фон" /> */}
              <p className={styles.plansName}>«МАКСИМУМ»</p>
              <p className={styles.plansPrice}>7.500 руб.</p>
              <a href="/" className={styles.plansButton}>ХОЧУ «МАКСИМУМ»</a>
              <div className={styles.plansContent}>
                <ul className={styles.plansClassicList}>
                  <li>
                  • Программа 5-ти дней интенсива
